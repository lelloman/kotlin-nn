...
class OnlineTrainingIntegrationTest {
    ...
    fun `online training is equal to batch training with batch size 1`() {
        ...
        val inputLayer1 = InputLayer(2)
        val hiddenLayer1 = DenseLayer.Builder()
                .size(10)
                .activation(activationFactory)
                .prevLayer(inputLayer1)
                .weightsInitializer(weightsInitializer1)
                .build()
        val outputLayer1 = DenseLayer.Builder()
                .size(1)
                .activation(activationFactory)
        ...
        val inputLayer2 = InputLayer(2)
        val hiddenLayer2 = DenseLayer.Builder()
                .size(10)
                .activation(activationFactory)
                .prevLayer(inputLayer2)
                .weightsInitializer(weightsInitializer2)
                .build()
        val outputLayer2 = DenseLayer.Builder()
                .size(1)
                .activation(activationFactory)
